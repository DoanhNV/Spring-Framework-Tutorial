...
import demo.pointcutdesignator.args.Animal3;
import demo.pointcutdesignator.args.AnimalAspect3;
import demo.pointcutdesignator.target.Animal2;
import demo.pointcutdesignator.target.AnimalAspect2;
import demo.pointcutdesignator.within.AnimalAspect;
import demo.pointcutdesignator.within.Person;

@Configuration
@EnableAspectJAutoProxy(proxyTargetClass = true)
// nếu proxyTargetClass = true thì target(...) đến 1 object mà "class được
// implement từ 1 interface"
// mới hoạt động
public class SpringConfig {
	...
	// arg
	@Bean("person4")
	public Animal3 createPerson4() {
		return new demo.pointcutdesignator.args.Person3();
	}

	@Bean("animalAspect4")
	public AnimalAspect3 createAnimalAspect4() {
		return new demo.pointcutdesignator.args.AnimalAspect3();
	}
}
